!function(e, undefined) {
    ...
    $(".piano").bind("selectstart dragstart", function(ev) {
        ...
        "keydown" == ev.type ? (lockEvent[keyNo] = !0, $key.addClass("active"), $key.parent().addClass("active")) : "keyup" == ev.type && (lockEvent[keyNo] = !1, 
        $key.removeClass("active"), $key.parent().removeClass("active")), lockEvent[keyNo] || notes[note].play();
