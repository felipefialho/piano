!function(e, undefined) {
    ...
    !function(e, t, n, r) {
        ...
        function T(t, n) {
            ...
            if (t = e.Event(t), t.type = n, s = t.originalEvent, o = e.event.props, i.search(/^(mouse|click)/) > -1 && (o = f), 
            s) for (p = o.length, l; p; ) l = o[--p], t[l] = s[l];
            if (i.search(/mouse(down|up)|click/) > -1 && !t.which && (t.which = 1), -1 !== i.search(/^touch/) && (a = x(s), 
            i = a.touches, c = a.changedTouches, h = i && i.length ? i[0] : c && c.length ? c[0] : r, 
            h)) for (d = 0, v = u.length; v > d; d++) l = u[d], t[l] = h[l];
            return t;
        }
        function N(t) {
            for (var r, s, n = {}; t; ) {
        ...
        function D(t, n, r) {
            var i;
            return (r && r[t] || !r && C(n.target, t)) && (i = T(n, t), e(n.target).trigger(i)), 
            i;
        }
        function P(t) {
        ...
        function H(t) {
            var r, i, n = x(t).touches;
            if (n && 1 === n.length && (r = t.target, i = N(r), i.hasVirtualBinding)) {
        ...
        function B(e) {
            g || (d || D("vmousecancel", e, N(e.target)), d = !0, M());
        }
        function j(t) {
            if (!g) {
        ...
        function R(t) {
            ...
            return {
                setup: function() {
                    ...
                    var o = e.data(this, i);
                    o[t] = !0, l[t] = (l[t] || 0) + 1, 1 === l[t] && b.bind(n, P), e(this).bind(n, q), 
                    y && (l.touchstart = (l.touchstart || 0) + 1, 1 === l.touchstart && b.bind("touchstart", H).bind("touchend", F).bind("touchmove", j).bind("scroll", B));
                },
                teardown: function() {
        ...
        var S, i = "virtualMouseBindings", s = "virtualTouchID", o = "vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "), u = "clientX clientY pageX pageY screenX screenY".split(" "), a = e.event.mouseHooks ? e.event.mouseHooks.props : [], f = e.event.props.concat(a), l = {}, c = 0, h = 0, p = 0, d = !1, v = [], m = !1, g = !1, y = "addEventListener" in n, b = e(n), w = 1, E = 0;
        e.vmouse = {
        ...
        y && n.addEventListener("click", function(t) {
            var i, o, u, a, f, l, n = v.length, r = t.target;
            if (n) for (i = t.clientX, o = t.clientY, S = e.vmouse.clickDistanceThreshold, u = r; u; ) {
                for (a = 0; n > a; a++) if (f = v[a], l = 0, u === r && Math.abs(f.x - i) < S && Math.abs(f.y - o) < S || e.data(u, s) === f.touchID) return t.preventDefault(), 
        ...
        e.event.special.scrollstart = {
            ...
            setup: function() {
                ...
                n.bind("vmousedown", function(r) {
                    ...
                    var u, s = r.target;
                    r.originalEvent, n.bind("vmouseup", a).bind("vclick", c), i.bind("vmousecancel", f), 
            ...
            setup: function() {
                ...
                n.bind(u, function(t) {
                    function o(t) {
                        i && (s = e.event.special.swipe.stop(t), Math.abs(i.coords[0] - s.coords[0]) > e.event.special.swipe.scrollSupressionThreshold && t.preventDefault());
                    }
                    var s, i = e.event.special.swipe.start(t);
        ...
        e.mobile = e.extend(e.mobile, {
            ...
            silentScroll: function(n) {
                "number" !== e.type(n) && (n = e.mobile.defaultHomeScroll), e.event.special.scrollstart.enabled = !1, 
                setTimeout(function() {
            ...
            nsNormalize: function(t) {
                return t ? i[t] || (i[t] = e.camelCase(e.mobile.ns + t)) : void 0;
            },
            getInheritedTheme: function(e, t) {
                for (var s, o, n = e[0], r = "", i = /ui-(bar|body|overlay)-([a-z])\b/; n && (s = n.className || "", 
                !(s && (o = i.exec(s)) && (r = o[2]))); ) n = n.parentNode;
                return r || t || "a";
            },
            ...
            haveParents: function(t, n) {
                ...
                for (var s, o, u, r = t.length, i = e(), a = 0; r > a; a++) {
            ...
            var i;
            return "undefined" != typeof t && (t && (t = e.mobile.nsNormalize(t)), i = arguments.length < 2 || n === r ? this.data(t) : this.data(t, n)), 
            i;
        }, e.jqmData = function(t, n, r) {
            var i;
            return "undefined" != typeof n && (i = e.data(t, n ? e.mobile.nsNormalize(n) : n, r)), 
            i;
    ...
    $(".piano").bind("selectstart dragstart", function(ev) {
        ...
        var me = $(this), noteTap = me.attr("data-note");
        notes[noteTap].play();
    });
}(jQuery);